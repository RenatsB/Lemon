...
if ($$LAB_BUILD) {
  ...
  !win32: LIBS += -lglfw
  !win32:LIBS += -lGL -lGLEW -lGLU $$NOISELIBPATH/libnoise.a
  win32:
  {
    INCLUDEPATH+="C:/Programming/glew/include"
    INCLUDEPATH+="C:/Programming/glm"
    INCLUDEPATH+="C:/Programming/glfw/include"
    DEPENDPATH+="C:/Programming/glfw/include"
    LIBS += -LC:/Programming/glfw/lib-vc2015/ -lglfw3dll
    DEFINES+=GLFW_DLL
  }
}
